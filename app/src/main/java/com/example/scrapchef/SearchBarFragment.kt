...
class SearchBarFragment : Fragment() {
    ...
    //prevent screen from rotating only in the search fragment. This is because the landscape keyboard is way too big for the layout to remain intact
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.searchFragmentLayout.setOnTouchListener { _, _ ->
            ...
            inputMethodManager.hideSoftInputFromWindow(
                binding.searchFragmentLayout.windowToken,
                HIDE_IMPLICIT_ONLY
            )
        ...
        binding.searchRecipes.setOnClickListener {
            ...
            if (currentIngredients.isEmpty()) {
                Snackbar.make(view, "Please select at least one ingredient", Snackbar.LENGTH_SHORT)
                    .show()
            } else {
    ...
    private fun addIngredientBubble(selectedIngredient: String) {
        ...
        //if current ingredient isn't already in the list
        if (!currentIngredients.contains(selectedIngredient)) {
            ...
            if (currentIngredients.count() == maxIngredients) {
                Snackbar.make(requireView(), "Maximum ingredients selected", Snackbar.LENGTH_SHORT).show()
            } else {
                //add ingredient to selected hashSet, update count display
                ...
                val cardView = CardView(requireContext()).apply {
                    ...
                    val bubbleShape = MaterialShapeDrawable().apply {
                        setCornerSize(
                            resources.getDimensionPixelSize(R.dimen.ing_card_corner_radius)
                                .toFloat()
                        )
                        fillColor = ColorStateList.valueOf(
                            ContextCompat.getColor(
                                context,
                                R.color.ingredient_bubble
                            )
                        )
                    }
                    ...
                    val linearLayout = LinearLayout(requireContext()).apply {
                        ...
                        val layoutPadding =
                            resources.getDimensionPixelSize(R.dimen.ing_bubble_layout_pad)
                    ...
                    val textView = TextView(requireContext()).apply {
                        ...
                        setTextSize(
                            ...
                            resources.getDimensionPixelSize(R.dimen.ing_name_text_size).toFloat()
                        )
                    ...
                    val button = Button(requireContext()).apply {
                        ...
                        setTextSize(
                            TypedValue.COMPLEX_UNIT_PX,
                            resources.getDimensionPixelSize(R.dimen.remove_ing_text_size).toFloat()
                        )
                        ...
                        setOnClickListener {
                            ...
                            while (viewToRemove != null && viewToRemove != binding.ingredientBubbleLayout) {
                                val parent =
                                    viewToRemove.parent as? ViewGroup // Get the parent of the current view
                            ...
                            binding.totalIngredient.text =
                                "${currentIngredients.count()}/$maxIngredients"
                        }
                    }
